            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="flex flex-col lg:flex-row gap-10 pb-10">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {/* Descripción */}
                        <div className="mb-10">
                            <h3 className="text-2xl font-bold text-foreground mb-4 font-serif">Descripción</h3>
                        ...
                        {parsedFeatures.length > 0 && (
                            <div className="mb-10">
                                <h3 className="text-2xl font-bold text-foreground mb-6 font-serif">Características</h3>
                        ...
                        {/* Ubicación / Mapa */}
                        <div className="mb-16">
                            <h3 className="text-2xl font-bold text-foreground mb-6 font-serif">Ubicación</h3>
